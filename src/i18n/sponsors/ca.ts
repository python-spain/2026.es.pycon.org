export const ca = {
  ...
  stats: {
    ...
    items: [
      { iconName: 'attendees', icon: '👥', value: '+800', label: 'assistents' },
      { iconName: 'speakers', icon: '🎤', value: '+80', label: 'ponents internacionals i locals' },
      { iconName: 'keynotes', icon: '🌟', value: '2', label: 'oradors plenaris' },
      { iconName: 'days', icon: '🗓', value: '3', label: 'dies de conferència' },
      { iconName: 'companies', icon: '🏢', value: '28', label: 'empreses patrocinadores' },
      { iconName: 'collaborators', icon: '🤝', value: '+8', label: 'associacions col·laboradores' },
    ],
  },
  objectives: {
  ...
  interests: {
    ...
    items: [
      ...
      { label: 'ENG. SOFTWARE', iconName: 'software-engineering', emoji: '🏗️', pc: '14%' },
      { label: 'DESENV. WEB', iconName: 'web-development', emoji: '💻', pc: '10%' },
      { label: 'COMUNITAT', iconName: 'community', emoji: '🤝', pc: '7%' },
      { label: 'DEVOPS & CLOUD', iconName: 'devops-cloud', emoji: '☁️', pc: '7%' },
      { label: 'ALTRES', iconName: 'others', emoji: '🔧', pc: '16%' },
    ],
  },
  audience: {
    ...
    items: [
      {
        ...
        rows: [
          { label: 'Número límit', data: ['Il·limitat', '9', '2', '2', '0'] },
