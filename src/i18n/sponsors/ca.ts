export const ca = {
  ...
  pastSponsors: {
    ...
    items: [
      { name: 'Nagarro', editions: '+3' },
      { name: 'Kraken', editions: '+3' },
      { name: 'Skydance Animation', editions: '+2' },
      { name: 'IBM', editions: '+2' },
      { name: 'Bloomberg Engineering', editions: '+2' },
      { name: 'Gisce', editions: '+2' },
      { name: 'Moeve', editions: '+2' },
      { name: 'Raiola Networks', editions: '+1' },
      { name: 'Perk', editions: '+1' },
      { name: 'Brite', editions: '+1' },
      { name: 'Inditex Tech', editions: '+1' },
      { name: 'Fever', editions: '+1' },
      { name: 'Kiwi.com', editions: '' },
      { name: 'NIQ', editions: '' },
      { name: 'Joinup', editions: '' },
      { name: 'Codurance', editions: '' },
      { name: 'Lareira Digital', editions: '' },
      { name: 'Innatial Developer', editions: '' },
      { name: 'Auth0 by Okta', editions: '' },
      { name: 'Kairos', editions: '' },
      { name: 'Gradiant', editions: '' },
      { name: 'Datamaran', editions: '' },
      { name: 'Kaleidos', editions: '' },
      { name: 'Freepik', editions: '' },
      { name: 'PWC', editions: '' },
      { name: 'Datadog', editions: '' },
      { name: 'Twilio', editions: '' },
    ],
  },
  collaborators: {
