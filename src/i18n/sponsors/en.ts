export const en = {
  ...
  stats: {
    ...
    items: [
      { iconName: 'attendees', icon: '👥', value: '+800', label: 'attendees' },
      { iconName: 'speakers', icon: '🎤', value: '+80', label: 'international and local speakers' },
      { iconName: 'keynotes', icon: '🌟', value: '2', label: 'keynote speakers' },
      { iconName: 'days', icon: '🗓', value: '3', label: 'conference days' },
      { iconName: 'companies', icon: '🏢', value: '28', label: 'sponsoring companies' },
      { iconName: 'collaborators', icon: '🤝', value: '+8', label: 'collaborating associations' },
    ],
  },
  objectives: {
  ...
  interests: {
    title: 'Interests',
    items: [
      { label: 'ML & AI', iconName: 'ml-ai', emoji: '🤖', pc: '29%' },
      { label: 'DATA SCIENCE', iconName: 'data-science', emoji: '📊', pc: '17%' },
      { label: 'SOFTWARE ENG', iconName: 'software-engineering', emoji: '🏗️', pc: '14%' },
      { label: 'WEB DEV', iconName: 'web-development', emoji: '💻', pc: '10%' },
      { label: 'COMMUNITY', iconName: 'community', emoji: '🤝', pc: '7%' },
      { label: 'DEVOPS & CLOUD', iconName: 'devops-cloud', emoji: '☁️', pc: '7%' },
      { label: 'OTHERS', iconName: 'others', emoji: '🔧', pc: '16%' },
    ],
  },
  audience: {
    ...
    items: [
      {
        ...
        rows: [
          { label: 'Limit number', data: ['Unlimited', '9', '2', '2', '0'] },
